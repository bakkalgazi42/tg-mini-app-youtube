...
const client = createThirdwebClient({
  clientId: "....", // Kendi clientId'nizi buraya ekleyin
});
...
export default function RockPaperScissors() {
  ...
  const contract = getContract({
    ...
    chain: {
      chainId: 10120,
      rpc: ["https://dymrollapp-evm.bakkaligazi.trade"],
      name: "bakkalgazi",
    },
    address: "0x4ad1AD500e76bEAb7e332cD8692E8BFF0862CdC9", // Token contract adresi
  });
